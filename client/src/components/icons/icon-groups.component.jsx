...
const IconGroups = props => {
    ...
    return (
        <svg className={props.className} xmlns="http://www.w3.org/2000/svg" viewBox="-3 -4 32 32" aria-labelledby="title">
        {/* <svg className={props.className} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="-3 -4 32 32" aria-labelledby="title"> */}
